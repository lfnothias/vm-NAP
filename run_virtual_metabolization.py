...
def run_biotransformer3(mode, list_smiles, list_compound_name, type_of_biotransformation, number_of_steps, output_name):
    ...
    for a, b in zip(list_smiles, list_compound_name):
        ...
        try:
            if mode == 'standard':
                biotransformcall = 'java -jar biotransformer/wishartlab-biotransformer3.0jar-cc4006a06ed3/BioTransformer3.0_20220615.jar -k pred -b ' + type_of_biotransformation +' -ismi "' + a +'" -ocsv biotransformer_temp_output.csv -s '+str(number_of_steps)
            else:
                biotransformcall = 'java -jar biotransformer/wishartlab-biotransformer3.0jar-cc4006a06ed3/BioTransformer3.0_20220615.jar -ismi "' + a +'" -ocsv biotransformer_temp_output.csv '+mode
